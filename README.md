...
- [x] [Character with longest consecutive repetition (6 kyu)](Solutions/Character_with_longest_consecutive_repetition_6kyu.py)
- [x] [Highest Scoring Word (6 kyu)](Solutions/Highest_Scoring_Word_6kyu.py)
